...
virtual const String32& get_object_name() const noexcept override {static String32 g_nullObjectName(U"UNKNOWN"); return g_nullObjectName;}	\
...
public:
	...
	virtual const String32& get_object_name() const noexcept = 0;
