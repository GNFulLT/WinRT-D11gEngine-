...
namespace winrt::GameEngineRT::implementation
{
    ...
    struct XamlMetaDataProvider : public ::winrt::GameEngineRT::implementation::XamlMetaDataProvider_base<XamlMetaDataProvider>
    {
...
namespace winrt::GameEngineRT::factory_implementation
{
