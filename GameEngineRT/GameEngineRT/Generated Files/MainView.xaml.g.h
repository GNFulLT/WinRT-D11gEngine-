...
namespace winrt::GameEngineRT::implementation
{
    using IInspectable = ::winrt::Windows::Foundation::IInspectable;

    template <typename D, typename ... I>
    struct MainViewT : public ::winrt::GameEngineRT::implementation::MainView_base<D,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector,
        ::winrt::Windows::UI::Xaml::Markup::IComponentConnector2,
        I...>
    {
        using base_type = typename MainViewT::base_type;
        using base_type::base_type;
        using class_type = typename MainViewT::class_type;
